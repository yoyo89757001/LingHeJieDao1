package com.example.xiaojun.linghejiedao.dialog;
...
import com.example.xiaojun.linghejiedao.ui.TianJiaGuangGaoActivity;
import com.example.xiaojun.linghejiedao.ui.VlcVideoActivity;
import com.example.xiaojun.linghejiedao.ui.XiTongSheZhiActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.bt3:
                ...
                break;
            case R.id.bt4:
                context.startActivity(new Intent(context,XiTongSheZhiActivity.class));
